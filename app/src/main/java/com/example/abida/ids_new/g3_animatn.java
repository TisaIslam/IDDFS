...
public class g3_animatn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g3_animatn);
        ...
        ImageView iv = (ImageView) findViewById(R.id.gif3);
        // iv.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT));


        if (inp.equals("f") || inp.equals("F"))
            iv.setBackgroundResource(R.drawable.ganim_f);

        else if (inp.equals("g") || inp.equals("G"))

            iv.setBackgroundResource(R.drawable.ganim_g);
        else if (inp.equals("c") || inp.equals("C"))

            iv.setBackgroundResource(R.drawable.ganim_c);
        else if (inp.equals("h") || inp.equals("H"))

            iv.setBackgroundResource(R.drawable.ganim_h);
        else if (inp.equals("e") || inp.equals("E"))
            iv.setBackgroundResource(R.drawable.ganim_e);
